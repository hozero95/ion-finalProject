    ...
    <section class="category">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
          ...
          <li>
            <a class="dropdown-item" href="#" v-on:click="showLowerPrice()"
              >낮은가격순</a
            >
          </li>
          <li>
            <a class="dropdown-item" href="#" v-on:click="showHigherPrice()"
              >높은가격순</a
            >
          </li>
          <li>
            <a class="dropdown-item" href="#" v-on:click="showManyReply()"
              >리뷰많은순</a
            >
          </li>
        </ul>
      ...
      <div class="category__seafoods">
        <div
          class="category__seafoods__wrap"
