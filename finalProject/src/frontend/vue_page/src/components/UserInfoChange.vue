        ...
        <div class="content_body">
          ...
          <div class="filed1">
            ...
            <div class="filed1_rbox">
              ...
              <input type="text" name="user_name" class="input_box leng" placeholder="주소" v-model="addr1" readonly
                required><br>
              <input type="text" name="user_name" class="input_box leng" placeholder="상세주소" v-model="addr2"
