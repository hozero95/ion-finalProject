      ...
      <div class="content_my">
        ...
        <div class="content_body">
          ...
          <div class="body_content">
            <h3 v-if="!writeReview_status && !showReview_status">
              미등록리뷰 n건
            </h3>
            ...
            <div class="content_tb">
              <table v-if="!writeReview_status && !showReview_status">
                ...
                <tbody>
                  ...
                  <tr
                    class="th_underbox"
                    v-for="(unRegister, index) in unRegisters"
                    v-bind:key="index"
                  >
              ...
              <div class="write_review" v-if="writeReview_status">
                ...
                <strong>주문상품 : </strong> {{ write_review.productName
                }}<br />
                ...
                <div class="add_review_button">
                  <button
                    type="button"
                    @click="addReview(write_review.paymentUnum)"
                  >
                    추가
                  </button>
            ...
            <div class="content_tb">
              ...
              <div class="show_review" v-if="showReview_status">
                ...
                <strong>주문상품 : </strong> {{ show_review.productName }}
                <br />
                <strong>리뷰작성일 : </strong>
                {{ dateFormat(show_review[0].replyRegdate) }} <br />
                <div class="write_review_box">
                  <textarea
                    name="ta_qna_modify"
                    id="qna_modify"
                    ...
                    :value="show_review[0].replyContent"
                    readonly
                  ></textarea>
                </div>
                <div class="add_review_button">
